...
| **Replicator** | ✅ Live | F₂→SO(3), cos θ = 1/3, εὐλόγησεν. 1→2 negentropic multiplication. |
...
- **Injector pack** — One clear “Get the injector pack” CTA (e.g. CSM). Formspree + email correct.
